...
# Методи прискорення пошуку. Хеш-таблиці. Бітові карти
...
Очевидно, що оскільки існує більше можливих значень ключа, ніж комірок в таблиці, то деякі значення ключів можуть відповідати одним і тим же коміркам таблиці. Даний випадок носить назву „колізія”, а такі ключі називаються „ключі-синоніми”.
...
Пошук в хеш-таблиці з ланцюгами переповнення здійснюється наступним чином. Спочатку обчислюється адреса за значенням ключа. Потім здійснюється послідовний пошук в списку, який зв'язаний з обчисленою адресою.
...
3. Якщо `t(a) = key`, то `t(a) = вилучено` і стоп елемент вилучений
...
1. Основи побудови та вибору хеш-функцій для різних типів даних.
2. Реалізація хеш-таблиць у C/C++: методи вирішення колізій (ланцюжки, відкрита адресація).
3. Порівняння ефективності різних методів вирішення колізій.
4. Динамічне рехешування та оцінка коефіцієнта заповнення таблиці.
5. Організація інвертованих індексів та бітових карт у базах даних.
6. Практичне застосування хеш-таблиць у сучасних інформаційних системах.

## Контрольні питання

1. Що таке хеш-таблиця? Які її основні властивості та сфери застосування?
2. Які вимоги до хорошої хеш-функції? Наведіть приклади хеш-функцій.
3. Що таке колізія у хеш-таблиці? Які основні методи її вирішення?
4. Як працює метод ланцюгів (separate chaining) та метод відкритої адресації (open addressing)?
5. Як реалізується вставка, пошук і видалення елементів у хеш-таблиці?
6. Що таке рехешування? Коли і навіщо воно використовується?
7. Як оцінити якість хеш-функції та ефективність хеш-таблиці?
8. Що таке інвертований індекс і бітова карта? Де вони застосовуються?
9. Які переваги та недоліки мають хеш-таблиці порівняно з іншими структурами даних?
10. Які типові помилки виникають при реалізації хеш-таблиць і як їх уникати?