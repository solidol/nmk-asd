...
Згідно цього алгоритму відрізок `b` … `e` слід ділити не навпіл, як у бінарному алгоритмі, а на відрізки, пропорційні ![](img/lec-11/11-003.png) та 1, в залежності від того, до якого краю ближче `key`. Замість оператора
...
char a[N]; у якому слід знайти заданий рядок символів: ![](img/lec-11/11-006.png) довжиною `m`.
