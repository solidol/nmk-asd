...
5. Модифікуйте програми наступним чином
   ...
   5. Перетворіть програми з урахуванням основних концепцій ООП. Там де це необхадно, створіть окремі файли для класів.
   6. Вихідний файл повинен мати наступну структуру:
