...
# Алгоритми сортування (4 години)

## Мета роботи 

Навчитися реалізовувати алгоритми сортування мовою програмування.
...
4. Використовуючи приклад, як зразок, виконати наступні завдання:
	...
	* Написати програму сортування масива методом вставки. Показати час виконання програми в мілісекундах. Зміти програму таким чином, що замість масивів використати однозв'язний список.
