...
1. Які існують алгоритми сортування масивів, і які з них є найбільш оптимальними за часом виконання?
2. Як працює алгоритм сортування "бульбашкою" (Bubble Sort), і який його час виконання в найгіршому випадку?
3. У чому відмінність між алгоритмами сортування злиттям (Merge Sort) та швидким сортуванням (Quick Sort)?
4. Що таке стабільне сортування, і які алгоритми сортування масивів є стабільними?
5. Як працює алгоритм сортування вибором (Selection Sort), і які його переваги та недоліки?
6. Як працює алгоритм вставки (Insertion Sort), і коли його найкраще використовувати?
   
7. Чи можна реалізувати сортування злиттям для однозв’язного списку? Якщо так, то як?
8. Чому сортування вставкою є більш ефективним для зв’язних списків порівняно з масивами?
9. Як реалізувати алгоритм сортування вибором для однозв’язного списку?
10. Як впливає структура зв’язного списку (одно- або двозв’язний) на вибір методу сортування?
11. Як сортувати зв’язний список за зростанням або спаданням, якщо ви маєте тільки його голову (головний елемент)?
