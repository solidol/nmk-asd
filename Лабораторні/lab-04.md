...
1. [Бінарне дерево на структурах С++](src/lab-04-001.cpp)
2. [Бінарне дерево на структурах С](src/lab-04-002.cpp)
3. [Бінарне дерево на С++ з використанням ООП](src/lab-04-003.cpp)
