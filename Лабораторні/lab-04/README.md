...
#### Основні поняття:
- **Корінь дерева** — перший (верхній) вузол дерева.
- **Лист** — вузол, який не має нащадків.
- **Висота дерева** — максимальна кількість вузлів на шляху від кореня до листа.
- **Піддерево** — будь-яке дерево, що є частиною більшого дерева.

#### Властивості:
- Кількість вузлів на рівні *k* не перевищує 2^k.
- Максимальна кількість вузлів у дереві висоти *h* — 2^(h+1) - 1.
...
- Для кожного вузла всі елементи в лівому піддереві менші за значення вузла, а всі елементи в правому піддереві — більші або рівні.

#### Основні операції:
- **Додавання (insert):** вставка нового елемента з дотриманням властивості БДП.
- **Пошук (search):** знаходження елемента за значенням.
- **Видалення (remove):** видалення вузла з перебудовою дерева.
- **Обхід дерева:** прямий (preorder), симетричний (inorder), зворотний (postorder).
...
#### Переваги:
- Швидкий пошук, вставка та видалення (O(log n) у збалансованому дереві).
...
- Потрібно слідкувати за балансуванням (AVL, Red-Black Tree тощо).
...
6. Використовуючи попередні лабораторні роботи, створіть програму, яка буде додавати випадкові числа одночасно у зв'язниц список та бінарне дерево пошуку.
   1. Згенеруйте та додайте 1000, 10000, 100000 випадкових чисел
   2. Повторіть дії 10 раз
   3. Використовуючи функції пошуку для списку та дерева оцініть середню кількість переходів по дереву та по списку. Зробіть висновок
...
1. [10.4: Бінарні дерева](https://ukrayinska.libretexts.org/%D0%9C%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D0%BA%D0%B0/%D0%9A%D0%BE%D0%BC%D0%B1%D1%96%D0%BD%D0%B0%D1%82%D0%BE%D1%80%D0%B8%D0%BA%D0%B0_%D1%82%D0%B0_%D0%B4%D0%B8%D1%81%D0%BA%D1%80%D0%B5%D1%82%D0%BD%D0%B0_%D0%BC%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D0%BA%D0%B0/%D0%9F%D1%80%D0%B8%D0%BA%D0%BB%D0%B0%D0%B4%D0%BD%D1%96_%D0%B4%D0%B8%D1%81%D0%BA%D1%80%D0%B5%D1%82%D0%BD%D1%96_%D1%81%D1%82%D1%83%D0%BA%D1%82%D1%83%D1%80%D0%B8_(Doerr_%D1%96_Levasseur)/10%3A_%D0%94%D0%B5%D1%80%D0%B5%D0%B2%D0%B0/10.04%3A_%D0%91%D1%96%D0%BD%D0%B0%D1%80%D0%BD%D1%96_%D0%B4%D0%B5%D1%80%D0%B5%D0%B2%D0%B0)
