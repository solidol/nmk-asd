...
- **Вставка (insert):** обчислюється хеш, елемент додається у відповідну позицію (або список).
- **Пошук (search):** обчислюється хеш, перевіряється відповідна позиція (або список).
- **Видалення (remove):** знаходиться елемент за хешем і видаляється.
- **Очищення (clear):** звільнення всієї пам'яті, зайнятої таблицею.

### Переваги та недоліки

**Переваги:**
- Дуже швидкий доступ до даних за ключем.
- Гнучкість у виборі типу ключа.

**Недоліки:**
- Необхідність правильної реалізації хеш-функції.
- Можливість великої кількості колізій при поганому розподілі ключів.
- Витрати пам'яті при низькому коефіцієнті заповнення.

### Види хеш-таблиць

- **Статичні** — розмір таблиці фіксований і не змінюється під час роботи.
- **Динамічні** — розмір таблиці може змінюватися (розширюватися або скорочуватися) в залежності від кількості елементів.
...
- Метод ділення: `h(key) = key % m`
- Метод множення
- Для рядків — підсумовування кодів символів, поліноміальні хеші тощо.
...
7. Додайте до програми можливість зберігання даних з колізійними хешами, методом ланцюгів, запропонованим в теоретичних відомостях
...
1. Що таке хеш-таблиця? Які її основні властивості та сфери застосування?
2. Які основні вимоги до хорошої хеш-функції? Наведіть приклади хеш-функцій.
3. Що таке колізія у хеш-таблиці? Чому вони виникають?
4. Які існують основні методи вирішення колізій? Опишіть їх переваги та недоліки.
5. Як відбувається вставка, пошук і видалення елементів у хеш-таблиці?
6. Як впливає розмір хеш-таблиці та коефіцієнт заповнення на її ефективність?
7. Які переваги та недоліки хеш-таблиць порівняно з іншими структурами даних?
8. Як правильно організувати очищення та звільнення пам'яті у хеш-таблиці?
9. Які типові помилки при реалізації хеш-таблиць?
10. Де в реальних задачах доцільно використовувати хеш-таблиці?
...
6. [12-13 Хеш-таблиці й алгоритми їх обробки](http://elcat.pnpu.edu.ua/docs/%D0%90%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%D0%B8%20%D1%96%20%D1%81%D1%82%D1%83%D0%BA%D1%82%D1%83%D1%80%D0%B8%20%D0%B4%D0%B0%D0%BD%D0%B8%D1%85/lab12-13_table.html)
